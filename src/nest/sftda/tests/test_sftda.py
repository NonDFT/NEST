...
class KnownValues(unittest.TestCase):
    ...
    def test_mcol_lda_tda_roks(self):
    ...
    def test_mcol_b3lyp_tda_roks(self):
    ...
    def test_col_b3lyp_tda_roks(self):
        mf = self.mol.ROKS(xc='B3LYP').run()
    ...
    def test_mcol_tpss_tda_roks(self):
    ...
    def test_mcol_cam_tda_roks(self):
    ...
    def test_col_cam_tda_roks(self):
        mf = self.mol.ROKS(xc='CAM-B3LYP').run()
